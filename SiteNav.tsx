        ...
        <div className={cn("flex flex-col gap-5 text-black-900")}>
          ...
          >
            <ul className={cn("flex flex-col gap-1.5 mt-2.5")}>
              <MenuItem
                href="https://cloud.phala.network/models?utm_source=phala.network&utm_medium=site-nav"
                title="Confidential AI Models"
                icon={<img src="/icons/menu-ai-models.png" className={cn("h-5 w-5")} />}
              >
                <p>Pre-trained models with privacy guarantees from $2.88/hour</p>
              </MenuItem>
              <MenuItem
                href="https://cloud.phala.network/gpu-inference?utm_source=phala.network&utm_medium=site-nav"
                title="GPU TEE Inference"
                icon={<IoServer className={cn("h-5 w-5")} />}
              >
                <p>NVIDIA H100/H200 with <5% performance overhead</p>
              </MenuItem>
              <MenuItem
                href="https://github.com/phala-network/eliza-builder?utm_source=phala.network&utm_medium=site-nav"
                title="Agent Framework"
                icon={<FiBox className={cn("h-5 w-5")} />}
              >
                <p>Build multi-agent systems with Eliza Builder</p>
              </MenuItem>
              <MenuItem
                href="https://cloud.phala.network/mcp?utm_source=phala.network&utm_medium=site-nav"
                title="MCP Hosting"
                icon={<img src="/icons/menu-mcp.png" className={cn("h-5 w-5")} />}
              >
                <p>Model Context Protocol secure serving</p>
              </MenuItem>
            </ul>
          </AnimatedDetails>
          <AnimatedDetails
          ...
          >
            <ul className={cn("flex flex-col gap-1.5 mt-2.5")}>
              <MenuItem
                href="https://docs.phala.network/quickstart?utm_source=phala.network&utm_medium=site-nav"
                title="Quick Start"
                icon={<MdArrowForward className={cn("h-5 w-5")} />}
              >
                <p>5-minute deployment guide with Docker tutorials</p>
              </MenuItem>
              <MenuItem
              ...
              >
                <p>API reference, SDK guides, and integration tutorials</p>
              </MenuItem>
              <MenuItem
                href="https://docs.phala.network/ai-agent/getting-started/dstack?utm_source=phala.network&utm_medium=site-nav"
                title="Builder Tools"
                icon={<img src="/icons/menu-dstack.png" className={cn("h-5 w-5")} />}
              >
                <p>Dstack framework, CLI tools, and templates library</p>
              </MenuItem>
              <MenuItem
                href="/builders-program?utm_source=phala.network&utm_medium=site-nav"
                title="Community"
                icon={<BsDiscord className={cn("h-5 w-5")} />}
              >
                <p>GitHub repos, Discord channels, and builder rewards</p>
              </MenuItem>
            </ul>
          </AnimatedDetails>
          <AnimatedDetails
          ...
          >
            <ul className={cn("flex flex-col gap-1.5 mt-2.5")}>
              <MenuItem
                href="https://docs.phala.network/overview/tee-technology?utm_source=phala.network&utm_medium=site-nav"
                title="TEE Technology"
                icon={<img src="/icons/menu-tee.png" className={cn("h-5 w-5")} />}
              >
                <p>Intel/AMD/NVIDIA hardware security with performance benchmarks</p>
              </MenuItem>
              <MenuItem
                href="https://proof.t16z.com?utm_source=phala.network&utm_medium=site-nav"
                title="Trust Center"
                icon={<img src="/icons/menu-trust.png" className={cn("h-5 w-5")} />}
              >
                <p>Live attestations and real-time security proofs</p>
              </MenuItem>
              <MenuItem
                href="https://docs.phala.network/security-audits?utm_source=phala.network&utm_medium=site-nav"
                title="Verification"
                icon={<IoNewspaperSharp className={cn("h-5 w-5")} />}
              >
                <p>Attestation explorer and customer verification tools</p>
              </MenuItem>
              <MenuItem
                href="/compliance?utm_source=phala.network&utm_medium=site-nav"
                title="Compliance"
                icon={<MdAssignment className={cn("h-5 w-5")} />}
              >
                <p>HIPAA, GDPR, SOC 2 Type II readiness</p>
              </MenuItem>
            </ul>
          </AnimatedDetails>
          ...
          >
            <ul className={cn("flex flex-col gap-1.5 mt-2.5")}>
              ...
              >
                <p>Become a worker with hardware requirements and earnings calculator</p>
              </MenuItem>
              <MenuItem
              ...
              >
                <p>Tokenomics, staking rewards, and cross-chain bridge</p>
              </MenuItem>
              <MenuItem
                ...
                icon={<MdAssignment className={cn("h-5 w-5")} />}
              >
                <p>Proposals, voting, and treasury participation</p>
              </MenuItem>
              <MenuItem
              ...
              >
                <p>Network stats, node operators, and technical specs</p>
              </MenuItem>
            </ul>
          </AnimatedDetails>
          ...
          <AnimatedDetails
            ...
            summary={
              <>
                Enterprise <FiChevronDown />
              </>
            }
            theIdxAtom={expandedMenuAtom} idx={5}
          >
            <ul className={cn("flex flex-col gap-1.5 mt-2.5")}>
              <MenuItem
                href="/solutions/financial-services?utm_source=phala.network&utm_medium=site-nav"
                title="Solutions by Industry"
                icon={<img src="/icons/menu-ai-execution-layer.png" className={cn("h-5 w-5")} />}
              >
                <p>Financial Services, Healthcare AI, Data Collaboration, AI SaaS</p>
              </MenuItem>
              <MenuItem
                href="https://cloud.phala.network/pricing?utm_source=phala.network&utm_medium=site-nav"
                title="Pricing"
                icon={<MdAssignment className={cn("h-5 w-5")} />}
              >
                <p>Cloud pricing calculator and enterprise volume discounts</p>
              </MenuItem>
              <MenuItem
                href="/contact-sales?utm_source=phala.network&utm_medium=site-nav"
                title="Support"
                icon={<MdAssignmentInd className={cn("h-5 w-5")} />}
              >
                <p>Contact sales, technical support, and professional services</p>
              </MenuItem>
              <MenuItem
                href="/resources?utm_source=phala.network&utm_medium=site-nav"
                title="Resources"
                icon={<IoNewspaperSharp className={cn("h-5 w-5")} />}
              >
                <p>Case studies, whitepapers, and webinars</p>
              </MenuItem>
            </ul>
          </AnimatedDetails>
        </div>
    ...
    <>
        ...
        >
          ...
          >
            ...
            <ul className="hidden xl:flex xl:items-center xl:gap-4 xl:h-[4rem] xl:col-start-5 xl:col-span-17 3xl:col-start-6 3xl:col-span-19 row-start-1">
              <SiteNavItem dropdownTarget="ai-solutions">AI Solutions</SiteNavItem>
              <SiteNavItem dropdownTarget="developers">Developers</SiteNavItem>
              <SiteNavItem dropdownTarget="security">Security</SiteNavItem>
              <SiteNavItem dropdownTarget="network">Network</SiteNavItem>
              <SiteNavItem dropdownTarget="enterprise">Enterprise</SiteNavItem>
          ...
          <div className={cn("flex flex-col justify-between w-full h-full py-7 px-5")}>
            <div className={cn("flex flex-col gap-2.5")}>
              ...
              <div className={cn("text-sm text-[#5A5A5C]")}>
                <p>Learn how to deploy secure AI models with hardware-level protection and enterprise-grade compliance.</p>
              </div>
            </div>
            <Link
              href="https://docs.phala.network/?utm_source=phala.network&utm_medium=site-nav"
      ...
      >
        ...
        <MenuItem
          ...
          icon={<IoServer className={cn("h-5 w-5")} />}
        >
          <p>Get support and resources to build secure AI applications</p>
        </MenuItem>
      </DropdownMenu>
      ...
      <DropdownMenu
        ...
        featured={(
          <div className={cn("flex flex-col justify-between w-full h-full py-7 px-5")}>
            <div className={cn("flex flex-col gap-2.5")}>
              <span className={cn("h-6 w-6 py-1")}>
                <img src="/icons/menu-ai-execution-layer.png" className={cn("h-5 w-5")} />
              </span>
              <h4 className="text-base text-[#323233] font-medium">Deploy AI Today</h4>
              <div className={cn("text-sm text-[#5A5A5C]")}>
                <p>Start with confidential AI models in 5 minutes. From $2.88/hour with enterprise-grade security.</p>
              </div>
            </div>
            <Link
      ...
      >
        <MenuItem
          ...
          icon={<img src="/icons/menu-ai-execution-layer.png" className={cn("h-5 w-5")} />}
        >
          <p>Pre-trained models: Llama, GPT variants with TEE protection</p>
        </MenuItem>
        <MenuItem
          href="https://cloud.phala.network/gpu-tee?utm_source=phala.network&utm_medium=site-nav"
          title="GPU TEE Inference"
          icon={<IconCompute className={cn("h-5 w-5")} />}
        >
          <p>NVIDIA H100/H200 with <5% overhead and real-time attestation</p>
        </MenuItem>
        <MenuItem
          href="https://cloud.phala.network/eliza?utm_source=phala.network&utm_medium=site-nav"
          title="Agent Framework"
          icon={<FiBox className={cn("h-5 w-5")} />}
        >
          <p>Eliza Builder: Multi-agent systems for Discord/Telegram bots</p>
        </MenuItem>
        <MenuItem
          href="https://cloud.phala.network/mcp?utm_source=phala.network&utm_medium=site-nav"
          title="MCP Hosting"
          icon={<IoServer className={cn("h-5 w-5")} />}
        >
          <p>Model Context Protocol with secure model serving</p>
        </MenuItem>
      </DropdownMenu>
      ...
      <DropdownMenu
        ...
        featured={(
          <div className={cn("flex flex-col justify-between w-full h-full py-7 px-5")}>
            <div className={cn("flex flex-col gap-2.5")}>
              <span className={cn("h-6 w-6 py-1")}>
                <svg className="h-5 w-5" viewBox="0 0 24 24"><path d="M12 1L3 5V11C3 16.55 6.84 21.74 12 23C17.16 21.74 21 16.55 21 11V5L12 1M12 7C13.33 7 14.67 7.33 15.5 8.17C16.33 9 16.67 10.33 16.67 11.67S16.33 14.33 15.5 15.17S13.33 16.33 12 16.33 9.33 16 8.5 15.17 7.33 13.83 7.33 12.5 7.67 10.17 8.5 9.33 10.67 7 12 7Z" fill="currentColor"/></svg>
              </span>
              <h4 className="text-base text-[#323233] font-medium">Trust Center</h4>
              <div className={cn("text-sm text-[#5A5A5C]")}>
                <p>Verify security in real-time. View live attestations and compliance reports.</p>
              </div>
            </div>
            <Link
              href="https://proof.t16z.com/?utm_source=phala.network&utm_medium=site-nav"
      ...
      >
        <MenuItem
          href="https://docs.phala.network/tee-technology?utm_source=phala.network&utm_medium=site-nav"
          title="TEE Technology"
          icon={<IconCompute className={cn("h-5 w-5")} />}
        >
          <p>How Intel/AMD/NVIDIA hardware protection works</p>
        </MenuItem>
        <MenuItem
          href="https://proof.t16z.com/?utm_source=phala.network&utm_medium=site-nav"
          ...
          icon={<img src="/icons/menu-ai-execution-layer.png" className={cn("h-5 w-5")} />}
        >
          <p>Live verification of 10K+ daily attestations</p>
        </MenuItem>
        <MenuItem
          href="https://docs.phala.network/compliance?utm_source=phala.network&utm_medium=site-nav"
          title="Compliance"
          icon={<MdAssignment className={cn("h-5 w-5")} />}
        >
          <p>HIPAA, GDPR, SOC 2 Type II readiness</p>
        ...
        <MenuItem
          ...
          icon={<IoNewspaperSharp className={cn("h-5 w-5")} />}
        >
          <p>Independent security assessments and audit reports</p>
        </MenuItem>
      </DropdownMenu>
      ...
      <DropdownMenu slug="enterprise">
        <MenuItem
          href="/solutions/financial-services"
          title="Financial Services"
          icon={<img src="/icons/menu-ai-execution-layer.png" className={cn("h-5 w-5")} />}
        >
          <p>Run risk models on sensitive financial data with verifiable security</p>
        </MenuItem>
        <MenuItem
          ...
          icon={<IoServer className={cn("h-5 w-5")} />}
        >
          <p>Deploy HIPAA-compliant AI models for medical diagnostics</p>
        </MenuItem>
        <MenuItem
          href="/solutions/saas"
          title="AI SaaS"
          icon={<FiBox className={cn("h-5 w-5")} />}
        >
          <p>Build AI features your enterprise customers can trust</p>
        </MenuItem>
        <MenuItem
          href="https://cloud.phala.network/pricing?utm_source=phala.network&utm_medium=site-nav"
          title="Pricing"
          icon={<MdAssignment className={cn("h-5 w-5")} />}
        >
          <p>Transparent pricing from $2.88/hour with enterprise plans</p>
        </MenuItem>
        <MenuItem
          href="/contact-sales"
          title="Contact Sales"
          icon={<MdAssignmentInd className={cn("h-5 w-5")} />}
        >
          <p>Get custom solutions and enterprise support</p>
        </MenuItem>
      </DropdownMenu>
    </>
  )
